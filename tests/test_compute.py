...
def test_pos_2_dist_none(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter1)
    data1 = Data(Color.RED, 38.45, 12.4)
    data2 = Data(Color.RED, 38.45)
...
def test_pos_2_dist_no_solution(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter1)
    corner1 = perimeter[0]
    corner2 = perimeter[1]
...
def test_pos_2_dist_easy(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter1)
...
def test_vector_from_colors(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter1)
...
def test_dist_from_angles_no_rectangle(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter1)
    mocker.patch('pleeplee.compute.dirInit', (10.0, 0.0))
    data1 = Data(Color.RED, 55.0)
    data2 = Data(Color.GREEN, -35.0)
    (x, y) = distanceFromAngles(data1, data2)
...
def test_dist_from_angles_no_rectangle_2(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter2)
    mocker.patch('pleeplee.compute.dirInit', (-10.0, -10.0))
    mocker.patch('pleeplee.compute.angleNorth', -45.0)
    mocker.patch('pleeplee.compute.angleToDirection', -90.0)
    data1_t2 = Data(Color.YELLOW, 19.0)
    data2_t2 = Data(Color.BLUE, -25.0)
    (x, y) = distanceFromAngles(data1_t2, data2_t2)
    errorMargin = 0.04 # 4cm
    assert abs(x - 6.4) < errorMargin
    assert abs(y - 4.5) < errorMargin


def test_compute_2_data_1(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter2)
    mocker.patch('pleeplee.compute.dirInit', (-10.0, -10.0))
    mocker.patch('pleeplee.compute.angleNorth', -45.0)
    mocker.patch('pleeplee.compute.angleToDirection', -90.0)
...
def test_compute_3_data(mocker):
    mocker.patch('pleeplee.compute.perimeter', testPerimeter2)
    mocker.patch('pleeplee.compute.dirInit', (-10.0, -10.0))
    mocker.patch('pleeplee.compute.angleNorth', -45.0)
    mocker.patch('pleeplee.compute.angleToDirection', -90.0)
